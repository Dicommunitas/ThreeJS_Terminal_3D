...
export const initialEquipment: Equipment[] = [
  ...
  // Tanks
  { tag: 'tank-01', name: 'Storage Tank Alpha', type: 'Tank', sistema: 'ODB', area: 'Área 33', operationalState: 'operando', product: '70H', position: { x: -8, y: 2.5, z: 12 }, radius: 3, height: 5, color: '#4FC3F7', details: 'Liquid storage tank for product 70H.', tankType: 'teto-fixo' },
  { tag: 'tank-02', name: 'Storage Tank Beta', type: 'Tank', sistema: 'ESCUROS', area: 'Área 33', operationalState: 'não operando', product: '6DH', position: { x: -2, y: 2, z: 12 }, radius: 2.5, height: 4, color: '#4DD0E1', details: 'Auxiliary liquid storage for product 6DH.', tankType: 'teto-flutuante-interno' },
  { tag: 'tank-03', name: 'Process Tank Gamma', type: 'Tank', sistema: 'NDD', area: 'Área 34', operationalState: 'em falha', product: '660', position: { x: 5, y: 3, z: 10 }, radius: 2, height: 6, color: '#4DB6AC', details: 'Processing tank for product 660.', tankType: 'teto-fixo' },
  ...
  { tag: 'ship-01', name: 'Oil Tanker "Norte"', type: 'Ship', sistema: 'QAV', area: 'Cais 01', operationalState: 'operando', product: 'Petróleo Cru', position: { x: -30, y: 2 /* Adjusted Y to make sure hull base is near Y=0 */, z: 0 }, size: { width: 10, height: 4, depth: 40 }, color: '#64B5F6', details: 'Oil tanker for crude oil transport.', capacityDwt: 50000 },
  { tag: 'barge-01', name: 'Fuel Barge B-01', type: 'Barge', sistema: 'LASTRO', area: 'Cais 02', operationalState: 'não operando', product: 'Diesel', position: { x: -25, y: 0.75 /* Adjusted Y for flatter profile */, z: 15 }, size: { width: 8, height: 1.5, depth: 22 }, color: '#81C784', details: 'Barge for diesel fuel.', capacityDwt: 5000 },
];
