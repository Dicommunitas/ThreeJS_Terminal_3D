...
/**
 * @fileOverview Hook customizado para configurar elementos básicos da cena Three.js, como iluminação e plano de chão.
 *
 * @module hooks/useThreeSceneElements
 * @see {@link module:core/three/scene-elements-setup~setupLighting} Para a função de configuração da iluminação.
 * @see {@link module:core/three/scene-elements-setup~setupGroundPlane} Para a função de configuração do plano de chão.
 *
 * @description
